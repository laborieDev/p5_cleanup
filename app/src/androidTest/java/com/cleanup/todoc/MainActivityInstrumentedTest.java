...
public class MainActivityInstrumentedTest {
    ...
    private void deleteAllAppData() {
        rule.getActivity().deleteDatabase("MyDatabase.db");
        PreferenceManager
    ...
    @Test
    public void A_addAndRemoveTask() {
        ...
        assertThat(listTasks.getAdapter().getItemCount(), equalTo(taskListSize));

        taskListSize--;

        onView(ViewMatchers.withId(R.id.list_tasks))
                .perform(RecyclerViewActions.actionOnItemAtPosition(0, new DeleteViewAction()));
        onView(ViewMatchers.withId(R.id.list_tasks)).check(withItemCount(taskListSize));
